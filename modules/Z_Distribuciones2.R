...
SideBarDistribucionElegida02_SERVER <- function(input, output, session,
  ...
  output$outMe_sidebar02_elegida <- renderUI({
    ...
    if (la_distribucion() == "001_Normal") return(SideBar01_Normal02("aver3")) else
      if (la_distribucion() == "002_t_de_Student") return(SideBar02_t02("aver3")) else
        if (la_distribucion() == "003_Chi_Cuadrado") return(SideBar03_chi02("aver3")) else
          if (la_distribucion() == "004_F_de_Fisher") return(SideBar04_f02("aver3")) else
            return(NULL)
...
MainPanelDistribucionElegida02_SERVER <- function(input, output, session,
  ...
  output$outMe_mainmenu02_elegida <- renderUI({
    ...
    if (la_distribucion() == "001_Normal") return(MainPanel01_Normal02("aver3")) else
      if (la_distribucion() == "002_t_de_Student") return(MainPanel02_t02("aver3")) else
        if (la_distribucion() == "003_Chi_Cuadrado") return(MainPanel03_chi02("aver3")) else
          if (la_distribucion() == "004_F_de_Fisher") return(MainPanel04_f02("aver3")) else
            return(NULL)
...
Server03_chi_Server02 <- function(input, output, session,
  ...
  output$armado01_chi <- renderUI({
    ...
    div( h2("Distribución Chi Cuadrado (Chi)"),
         plotOutput(ns("distPlot1")), br(),
         br(),
         br(),
