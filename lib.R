...
Distribucion.Normal <- function(mu_variable, sigma_cuadrado_variable, sigma_variable, 
                                opciones, 
                                intervalo,
                                color_variable,
  ...
  # ejecucion tiene 4 valores posibles
  # 1) "all" que es todo
  # 2) "tablas" que es solo hacer las tablas
  # 3) "grafico01", que ejecuta todo pero no da return de generacion de tablas
  # 4) "grafico02", que ejecuta todo pero no da return de generacion de tablas
  ...
  # Tabla interna 01
  # tabla_interna01 <<- c(as.list(environment()), list(...))
  # tabla_interna01 <- do.call(cbind.data.frame, tabla_interna01)
  
  # tabla_interna01 <- data.frame(mu_variable, sigma_cuadrado_variable, sigma_variable,
  #                               opciones, intervalo, color_variable, var1, var2, z1, z2,
  #                               probabilidad_externo, porcentaje_externo)
  tabla_interna01 <- data.frame(mu_variable, sigma_cuadrado_variable, sigma_variable,
  ...
  # Grafico de normal estandar (Z)
  if(ejecucion == "all" | ejecucion == "grafico01") {
  ...
  # Grafico Normal de la variable original
  if(ejecucion == "all" | ejecucion == "grafico02") {
    # Parametros
    mu_variable <- tabla_interna01[1,1]
    sigma_variable <- tabla_interna01[1,3]
